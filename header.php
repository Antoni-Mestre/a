...
?>
<?php
$metaGeneratorContent = 'Nicepage 4.9.1, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'website1829492' ); ?></a>
    <?php if (!$hideHeader) { ?>
    <header class="u-clearfix u-header u-header" id="sec-1e05">
      ...
      <div class="u-custom-menu u-nav-container-collapse">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    'is_mega_menu' => false,
                    'menu_class' => 'u-custom-font u-nav u-text-font u-unstyled u-nav-1',
                    'item_class' => 'u-nav-item',
                    'link_class' => 'u-button-style u-nav-link u-text-active-palette-1-base u-text-grey-50 u-text-hover-palette-2-base',
                    'link_style' => 'padding: 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-c5d9-19',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => '',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-c5d9-20',
                    'submenu_item_class' => 'u-nav-item',
